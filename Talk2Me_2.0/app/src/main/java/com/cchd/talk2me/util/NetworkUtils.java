...
public class NetworkUtils {
    ...
    final static String BASE_INSERT_USER_URL =  "https://cchdnigeria.org/android_api/add_user.php";
    final static String BASE_SELECT_USER_URL =  "https://cchdnigeria.org/android_api/select_user.php";
    final static String BASE_USER_LIST_URL =  "https://cchdnigeria.org/android_api/userlist.php";
    final static String BASE_USER_LIST_ONE_URL =  "https://cchdnigeria.org/android_api/v1/userlist_one.php";

    final static String BASE_INSERT_MSG_URL =  "https://cchdnigeria.org/android_api/add_msg.php";
    final static String BASE_SELECT_MSG_URL =  "https://cchdnigeria.org/android_api/select_msg.php";
